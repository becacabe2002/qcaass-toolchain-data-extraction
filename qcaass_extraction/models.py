...
from .config import FLASH_MODEL, MAX_API_RETRIES, STRONG_MODEL
...
def get_flash_model():
    ...
    # max_retries adds exponential backoff on 429/throttle so high concurrency
    # across documents stays under the API tier's rate limits.
